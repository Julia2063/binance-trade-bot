                    ...
                    <Tabs>
                        ...
                        <TabPanel>
                            ...
                            <div className="wallet-body">
                                ...
                                <div className="price">
                                    <h6>
                                        {Intl.NumberFormat('en', {minimumFractionDigits: 2, maximumFractionDigits: 2}).format(user.balanceTokens)}
                                    </h6>
                                    <div className="sale success">BCB</div>
                                </div>
                                <p>
                                    {Intl.NumberFormat('en', {style: 'currency', currency: 'USD', minimumFractionDigits: 2, maximumFractionDigits: 2}).format(user.balanceTokens)}
                                </p>
                                </div>
                                <div className="right">
                                <form action="/wallet">
