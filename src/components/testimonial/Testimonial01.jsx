    ...
    const [dataBlock] = useState(
        {
            ...
            desc : 'Transform Your idea into Reality With BinanceBot',
            text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur, ducimus.',
        }
    );
                ...
                <div className="col-xl-6 col-md-12">
                    ...
                    <div className="swiper swiper-thumb1">
                        ...
                        <div className="swiper-slide">
                            <img src={avt1} alt="BinanceBot" />
                        </div>
                        <div className="swiper-slide">
                            <img src={avt2} alt="BinanceBot" />
                        </div>
                        <div className="swiper-slide">
                            <img src={avt3} alt="BinanceBot" />
                        </div>
                        </div>
                    </div>
