    ...
    const [dataBlock] = useState(
        {
            ...
            desc : 'With BinanceBot, you can be sure your trading skills are matched',
        }
    );
    ...
    const [dataList] = useState([
        {
            ...
            text: 'Manage your assets with us'
        },
        {
        ...
        <section className="download">
            <div className="container">
                ...
                <div className="col-xl-6 col-md-12">
                    ...
                    {/*    <Link to="#"*/}
                    {/*    ><img src={img1} alt="BinanceBot"*/}
                    {/*    /></Link>*/}
                    {/*    <Link to="#"*/}
                    {/*    ><img src={img2} alt="BinanceBot"*/}
                    {/*    /></Link>*/}
                    {/*</div>*/}
                    </div>
                </div>
