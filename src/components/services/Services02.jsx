...
function Services02(props) {
    ...
    const [dataBlock] = useState(
        {
            heading: 'Why choose BinanceBot',
            desc : 'BinanceBot has a variety of features that make it the best place to start trading'
        }
    )
        ...
        <div className="container">
                ...
                <ul className="list">
                    {
                        ...
                        <li key={idx.id} className={idx.active}>
                            <div className={`icon ${idx.bg}`}>
                                <img src={idx.icon} alt="BinanceBot" />
                            </div>
            ...
            <div className="col-xl-6 col-md-12">
...

                        {
                            dataIcon.map((data,idx) => (
                                <li className="icon" key={idx}>
                                    <Link to="#"
                                    ><img src={data.icon} alt="BinanceBot"
                                    /></Link>
                                </li>
                            ))
                        }
                ...
                <div className="crypto-box">
                    <img className="arrow" src={arrow} alt="BinanceBot" />
                    <div className="left">
                    <img src={bitcoin} alt="BinanceBot" />
                    <div>
                        <h6>BTC</h6>
                        <p>+1.46%</p>
                    </div>
